...
var platformConfig = {
  development: {
    ...
    mongo: {
      url: 'mongodb://localhost:27017/nestpad-data-dev'
    }
  },
  ...
  test: {
    ...
    mongo: {
      url: 'mongodb://localhost:27017/nestpad-data-test'
    }
  },
  ...
  production: {
    ...
    mongo: {
      url: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://localhost:27017/nestpad-data'
    }
  }
};
